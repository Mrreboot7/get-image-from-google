...
pushkubeflow:
	docker push registry.cn-shenzhen.aliyuncs.com/aaskubeflow/istio-node-agent-k8s:release-1.3-latest-daily
	docker push registry.cn-shenzhen.aliyuncs.com/aaskubeflow/istio-kubectl:release-1.3-latest-daily
	docker push registry.cn-shenzhen.aliyuncs.com/aaskubeflow/istio-sidecar_injector:release-1.3-latest-daily
	docker push registry.cn-shenzhen.aliyuncs.com/aaskubeflow/istio-mixer:release-1.3-latest-daily
	docker push registry.cn-shenzhen.aliyuncs.com/aaskubeflow/istio-proxyv2:release-1.3-latest-daily
	docker push registry.cn-shenzhen.aliyuncs.com/aaskubeflow/istio-pilot:release-1.3-latest-daily
	docker push registry.cn-shenzhen.aliyuncs.com/aaskubeflow/istio-citadel:release-1.3-latest-daily
	docker push registry.cn-shenzhen.aliyuncs.com/aaskubeflow/istio-galley:release-1.3-latest-daily
	docker push registry.cn-shenzhen.aliyuncs.com/aaskubeflow/kubeflow-images-public-kubernetes-sigs-application:1.0-beta
